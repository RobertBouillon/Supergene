...
namespace System
{
  public struct UInt128 : IFormattable, IComparable, IComparable<UInt128>, IEquatable<UInt128>
  {
    ...
    private static readonly UInt128 _MAX_VALUE = ~(UInt128)0;
    private static readonly UInt128 _ZERO = (UInt128)0;
    private static readonly UInt128 _ONE = (UInt128)1;

    public static UInt128 MinValue { get { return _ZERO; } }
    public static UInt128 MaxValue { get { return _MAX_VALUE; } }
    public static UInt128 Zero { get { return _ZERO; } }
    public static UInt128 One { get { return _ONE; } }
    ...
    public bool IsZero => (lo | hi) == 0;
    public bool IsOne => (hi ^ lo) == 1;
    public bool IsPowerOfTwo => (this & (this - 1)).IsZero;
    public bool IsEven => (lo & 1) == 0;
    ...
    public static float ConvertToFloat(ref UInt128 a) => (a.hi == 0) ? a.lo : a.hi * (float)ulong.MaxValue + a.lo;
    public static double ConvertToDouble(ref UInt128 a) => (a.hi == 0) ? a.lo : a.hi * (double)ulong.MaxValue + a.lo;
    public static explicit operator sbyte(UInt128 a) => (sbyte)a.lo;
    public static explicit operator byte(UInt128 a) => (byte)a.lo;
    public static explicit operator short(UInt128 a) => (short)a.lo;
    public static explicit operator ushort(UInt128 a) => (ushort)a.lo;
    public static explicit operator int(UInt128 a) => (int)a.lo;
    public static explicit operator uint(UInt128 a) => (uint)a.lo;
    public static explicit operator long(UInt128 a) => (long)a.lo;
    ...
    public static explicit operator decimal(UInt128 a)
    {
      if (a.hi == 0)
        return a.lo;
      var shift = Math.Max(0, 32 - GetBitLength(a.hi));
      RightShift(out var ashift, ref a, shift);
      return new decimal((int)a.r0, (int)a.r1, (int)a.r2, false, (byte)shift);
    }

    public static implicit operator BigInteger(UInt128 a) => (a.hi == 0) ? a.lo : (BigInteger)a.hi << 64 | a.lo;
    ...
    //public static uint operator &(UInt128 a, uint b) => (uint)a.lo & b;
    //public static uint operator &(uint a, UInt128 b) => a & (uint)b.lo;
    //public static ulong operator &(UInt128 a, ulong b) => a.lo & b;
    //public static ulong operator &(ulong a, UInt128 b) => a & b.lo;
    ...
    public int CompareTo(UInt128 other) => (hi != other.hi) ? hi.CompareTo(other.hi) : lo.CompareTo(other.lo);
    public int CompareTo(int other) => (hi != 0 || other < 0) ? 1: lo.CompareTo((ulong)other);
    public int CompareTo(uint other) => (hi != 0) ? 1: lo.CompareTo((ulong)other);
    public int CompareTo(long other) => (hi != 0 || other < 0) ? 1 : lo.CompareTo((ulong)other);
    public int CompareTo(ulong other) => (hi != 0) ? 1 : lo.CompareTo(other);

    public int CompareTo(object obj) =>
      (obj is null) ? 1 :
      (!(obj is UInt128)) ? throw new ArgumentException() :
      CompareTo((UInt128)obj);

    private static bool LessThan(ref UInt128 a, long b) => b >= 0 && a.hi == 0 && a.lo < (ulong)b;
    private static bool LessThan(long a, ref UInt128 b) => a < 0 || b.hi != 0 || (ulong)a < b.lo;
    private static bool LessThan(ref UInt128 a, ulong b) => a.hi == 0 && a.lo < b;
    private static bool LessThan(ulong a, ref UInt128 b) => b.hi != 0 || a < b.lo;
    private static bool LessThan(ref UInt128 a, ref UInt128 b) => (a.hi != b.hi) ? a.hi < b.hi : a.lo < b.lo;

    public static bool Equals(ref UInt128 a, ref UInt128 b) => a.lo == b.lo && a.hi == b.hi;
    public bool Equals(UInt128 other) => lo == other.lo && hi == other.hi;
    public bool Equals(int other) => other >= 0 && lo == (uint)other && hi == 0;
    public bool Equals(uint other) => lo == other && hi == 0;
    public bool Equals(long other) => other >= 0 && lo == (ulong)other && hi == 0;
    public bool Equals(ulong other) => lo == other && hi == 0;

    public override bool Equals(object obj) => (!(obj is UInt128)) ? false : Equals((UInt128)obj);
    ...
    {
      if ((a.hi | b.hi) == 0)
        Multiply64(out c, a.lo, b.lo);
      else if (a.hi == 0)
        Multiply128(out c, ref b, a.lo);
      else if (b.hi == 0)
        Multiply128(out c, ref a, b.lo);
      else
    ...
    private static void Multiply(out UInt256 c, ref UInt128 a, ref UInt128 b)
    {
      ...
      Multiply64(out c00, a.lo, b.lo);
      Multiply64(out c01, a.lo, b.hi);
      Multiply64(out c10, a.hi, b.lo);
      Multiply64(out c11, a.hi, b.hi);
      var carry1 = (uint)0;
      var carry2 = (uint)0;
      c.s0 = c00.S0;
      c.s1 = Add(Add(c00.hi, c01.lo, ref carry1), c10.lo, ref carry1);
      c.s2 = Add(Add(Add(c01.hi, c10.hi, ref carry2), c11.lo, ref carry2), carry1, ref carry2);
      c.s3 = c11.hi + carry2;
    ...
    public static void Cube(out UInt128 c, ref UInt128 a)
    {
      if (a.hi == 0)
      {
        Square64(out var square, a.lo);
        Multiply(out c, ref square, a.lo);
      }
      else
      {
    ...
    {
      Multiply64(out w, u.lo, v.lo);
      w.hi += u.hi * v.lo + u.lo * v.hi;
    }

    public static void Divide(out UInt128 w, ref UInt128 u, uint v)
    {
      if (u.hi == 0)
        Divide64(out w, u.lo, v);
      else if (u.hi <= uint.MaxValue)
    ...
    public static void Divide(out UInt128 c, ref UInt128 a, ref UInt128 b)
    {
      if (LessThan(ref a, ref b))
        ...
        Divide(out c, ref a, b.lo);
      else if (b.hi <= uint.MaxValue)
    ...
    public static uint Remainder(ref UInt128 u, uint v) =>
      (u.hi == 0) ? (uint)(u.lo % v) :
      (u.hi <= uint.MaxValue) ? Remainder96(ref u, v) :
    ...
    public static void Remainder(out UInt128 c, ref UInt128 a, ref UInt128 b)
    {
      if (LessThan(ref a, ref b))
        ...
        Create(out c, Remainder(ref a, b.lo));
      else if (b.hi <= uint.MaxValue)
    ...
    private static void Divide128(out UInt128 w, ref UInt128 u, ulong v)
    {
      ...
      w.hi = DivRem(r4, ref r3, ref r2, v1, v2);
      var q1 = DivRem(r3, ref r2, ref r1, v1, v2);
      var q0 = DivRem(r2, ref r1, ref r0, v1, v2);
      w.lo = (ulong)q1 << 32 | q0;
      Debug.Assert((BigInteger)w == (BigInteger)u / v);
    ...
    public static void ModMul(out UInt128 c, ref UInt128 a, ref UInt128 b, ref UInt128 modulus)
    {
      ...
      {
        UInt128 product;
        Multiply64(out product, a.lo, b.lo);
        Create(out c, UInt128.Remainder(ref product, modulus.lo));
      }
      else
      {
        UInt256 product;
    ...
    public static void ModMul(ref UInt128 a, ref UInt128 b, ref UInt128 modulus)
    {
      if (modulus.hi == 0)
      {
        UInt128 product;
        Multiply64(out product, a.lo, b.lo);
        Create(out a, UInt128.Remainder(ref product, modulus.lo));
      }
      else
      {
        UInt256 product;
    ...
    {
      if (a.hi == 0 && a.lo <= maxRep)
        return (ulong)Math.Sqrt(a.lo);
      var s = (ulong)Math.Sqrt(ConvertToDouble(ref a));
      if (a.hi < maxRepSquaredHigh)
      {
        UInt128 s2;
        Square(out s2, s);
        var r = a.lo - s2.lo;
    ...
    {
      if (a.hi == 0 && a.lo <= maxRep)
        return (ulong)Math.Ceiling(Math.Sqrt(a.lo));
    ...
    private static ulong LeftShift64(ref UInt128 c, int d)
    {
      if (d == 0)
        return 0;
      var dneg = 64 - d;
      var result = c.hi >> dneg;
      c.hi = c.hi << d | c.lo >> dneg;
      c.lo <<= d;
      return result;
    }
    ...
    public static void GreatestCommonDivisor(out UInt128 c, ref UInt128 a, ref UInt128 b)
    {
      ...
      UInt128 a1, b1;
      if ((a.hi == 0) != (b.hi == 0) && !a.IsZero && !b.IsZero)
      {
      ...
      while (a1.hi != 0 && !b.IsZero)
      {
        // Extract the high 63 bits of a and b.
        var norm = 63 - GetBitLength(a1.hi);
        UInt128 ahat, bhat;
        Shift(out ahat, ref a1, norm);
        Shift(out bhat, ref b1, norm);
        var uhat = (long)ahat.hi;
        var vhat = (long)bhat.hi;
    ...
    {
      UInt128 carry;
      Multiply64(out carry, u.lo, v.lo);
      var t0 = carry.lo;
      Multiply64(out carry, u.hi, v.lo, carry.hi);
      var t1 = carry.lo;
      var t2 = carry.hi;

      var m = t0 * k0;
      Multiply64(out carry, m, n.hi, MultiplyHigh64(m, n.lo, t0));
      Add(ref carry, t1);
      t0 = carry.lo;
      Add(out carry, carry.hi, t2);
      t1 = carry.lo;
      t2 = carry.hi;

      Multiply64(out carry, u.lo, v.hi, t0);
      t0 = carry.lo;
      Multiply64(out carry, u.hi, v.hi, carry.hi);
      Add(ref carry, t1);
      t1 = carry.lo;
      Add(out carry, carry.hi, t2);
      t2 = carry.lo;
